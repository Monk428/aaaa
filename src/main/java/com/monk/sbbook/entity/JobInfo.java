...
public class JobInfo {
    ...
    private String triggerName;//执行名称
    ...
    public JobInfo(String jobName, String jobGroup, String description, String jobClassName, String cronExpression, String triggerName) {
        super();
